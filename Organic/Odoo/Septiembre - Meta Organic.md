---
date: 2026-09
brand: Odoo Community
platform: [Instagram, Facebook]
frequency: 3 posts per week
month: Septiembre - 2026
tags: [organic, social-media, instagram, facebook, content-calendar, odoo, lead-generation]
---

# Organic Content Calendar - Odoo Community - Septiembre 2026
...
| Fecha | Día | Tipo | Arte/Idea | Visual Descripción | Copy (Texto) | Hashtags | CTA |
|-------|-----|------|-----------|------------------|--------------|----------|-----|
| 2026-09-30 | Martes | Static | "Cierre de Mes + Preview" | Imagen: Resumen septiembre + preview octubre | "Septiembre fue increíble con ustedes 🙌 En octubre vienen sorpresas... ¿listas?" | #Septiembre #Odoo #ProximoMes | "Síguenos" |
...
2. **Semana 2:** Solución + Social Proof (Build trust)
3. **Semana 3:** Datos + Comparativa (Justify decision)
4. **Semana 4:** Community + Urgencia (Drive conversion)

### Métricas Target
- **Engagement Rate:** >3%
- **Reach:** 5K-10K por post
- **CTR:** >2% en posts con links
- **Conversiones:** Mínimo 5 leads por semana desde organic

---

## 📋 Checklist de Implementación

- [ ] Crear assets en Canva/Design basados en template
- [ ] Descargar imágenes en 1080x1350 (Instagram) + 1200x628 (Facebook)
- [ ] Revisar copy para ortografía/tone
- [ ] Programar en Meta Business Suite
- [ ] Configurar hashtags relevantes
- [ ] Establecer A/B testing (hora de publicación)
- [ ] Rastrear metrics en analytics
- [ ] Responder a comentarios en máximo 24h

---

## 🔗 Enlaces Relacionados

- [[Organic/Odoo/Agosto - Meta Organic]] - Calendario anterior
- [[Reports/2026-09-04 - Reporte Performance]] - Performance de campañas pagadas
- [[cloud.md]] - Dashboard principal

---

## 📈 Follow-up (Post Octubre)

Para octubre considerar:
- Incrementar a 4 posts/semana si engagement es >3%
- A/B test: Reels vs Carousel (mayor impacto)
- Crear series (ej: "Lunes de Transformación")
- Colaboraciones con influencers/partners
